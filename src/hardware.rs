...
pub(crate) trait Hardware {
    ...
    /// requested timestamp.
    fn read_outgoing_packet(no_earlier_than: Option<u64>);
    ...
    fn send_outgoing_packet(&mut self, packet: &[u8], destination: std::net::SocketAddr, timestamp: Option<u64>) -> std::io::Result<()>;
